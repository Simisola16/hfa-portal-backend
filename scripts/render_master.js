...
async function renderTemplate() {
  const pdfBuf = fs.readFileSync(path.resolve(__dirname, '../assets/certificates/Template GSO Scheme (meat) Cert.pdf'));
  ...
  await c.screenshot({ path: path.resolve(__dirname, '../template_rendered.png') });
  await browser.close();
  console.log('Saved template_rendered.png');
}
